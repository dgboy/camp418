...
console.log("- Я загадал число размером от 3 до 6 цифр. Ты должен его отгадать за 5 попыток. На этом всё. Дерзай!\n");
...
// PC приветсвует игрока и объясняет правила
// PC загадывает число: makeNumber()
		// Рандомизировать длину числа от 3 до 6 (вкл.)
		// Загадать первую цыфру от 1 до 9 (вкл.)
		// Загадывать оставшиеся цыфры от 0 до 9, проверяя текущее число

// Player пытается его разгадать 
	// У Player не получается, PC даёт подсказки: giveHint()
	// У Player заканчиваются попытки, AI зларадствует: loseMessage()

// У Player получается, PC поздравляет игрока: winMessage()
